classdef (Sealed) IvTobiiEyeX < ivis.eyetracker.IvDataInput
    ...
    methods (Access = public)
        ...
        function [n,saccadeOnTime] = refresh(obj, logData, samples) % interface implementation
            if nargin < 2
                logData = true;
            end
            ...
            saccadeOnTime = obj.processData(xy(:,1),xy(:,2),CPUtime,isvalid,pd, zL_mm,zR_mm, logData);
