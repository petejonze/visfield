classdef (Abstract) IvDataInput < Singleton
    ...
    methods(Access = protected)
        ...
        function saccadeOnTime = processData(obj, x, y, t, vldty, p, zL_mm,zR_mm, logData)
            ...
            newData = [x y t-obj.expectedLatency_sec vldty p nan(length(x),4) zL_mm zR_mm x y]; % x/y added again in the last two columns so that a COMPLETELY unprocessed copy of each is preserved
