...
%
%     WARNING:  Lsqfitma.m must be present in a directory that is in your
%               MATLABPATH in order for this algorithm to execute properly.
 
function [m,b,r,sm,sb,xc,yc,ct]=lsqcubic(X,Y,sX,sY,tl)
