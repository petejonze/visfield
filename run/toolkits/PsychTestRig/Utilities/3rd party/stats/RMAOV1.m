function [P, table, eta2, pEta2] = RMAOV1(X,alpha,printOutput,IVname)
...
table(2,:) = {'Subjects'               	,SSS ,v2,MSS,F2,P(2)};
table(3,:) = {sprintf('IV: %s', IVname)	,SSA ,v1,MSA,F1,P(1)};
table(4,:) = {'Error'                   ,SSE ,v3,MSE,[],[]};
table(5,:) = {'Total'                   ,SST ,dfT,[],[],[]};

% effect size
SS_factor = table{3,2};
SS_error = table{4,2};
eta2 = SS_factor / SST;
pEta2 = SS_factor / (SS_factor + SS_error);
